...
SocketProtocolDelegate
{
    ...
    func getServerIp(info: String)
    {
        ...
        message_struct.type = Motion.Message_.ActionType.Engage.rawValue as Int32
        message_struct.imagefilepath = "kdafkdfhkjasdhfkaskdjfhaksdjfh asdhf kasdh fkasjhd fkjahsd fasdhfjkashd faksdhf akdshf akdshf akh"
        

        //socket.sendMessage(message_struct)
